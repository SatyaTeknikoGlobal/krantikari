    ...
    <div class="container-fluid">
     ...
     <div class="row pt-2 pb-2">
        ...
        <div class="col-sm-9">
            ...
            <li class="breadcrumb-item active"><a href="javaScript:void();">Quizzes</a></li>
       ...
       <div class="btn-group float-sm-right">
        ...
        <a type="button" class="btn btn-primary waves-effect waves-light" href="{{ route('quiz.create')}}">Add</a>
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            ...
            <div class="card-header"><i class="zmdi zmdi-account "></i> Quiz List </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                          ...
                          <br>
                            <a href="{{ route('report.show', ['id'=>$row->id]) }}" class="btn btn-warning btn-sm flex">Report</a>
                          
                            <a href="{{ route('quiz.edit', $row->id) }}" class="btn btn-primary btn-sm flex"><i class="fa fa-edit" aria-hidden="true"></i> Edit</a>
                              <!-- Modal -->
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-header">
                                            ...
                                            <h5 class="modal-title" id="exampleModalLabel">Import Question</h5>
                                             <a href="{{URL::asset('uploads/iasgyanquestion.xlsx')}}" download="" class="btn btn-sm btn-dark mx-2">Sample</a>
                            ...
                            <form action="{{ route('quiz.destroy',$row->id) }}" method="POST" id="delete_record">
