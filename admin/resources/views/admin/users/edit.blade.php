	...
	<div class="card">
        ...
        <div class="card-header">Edit Users</div>
          ...
          <div class="form-group row">
            ...
            <input type="email" class="form-control form-control-rounded" id="input-26" placeholder="Enter Email" name="email" value="{{$data->email}}">
          ...
          <div class="form-group row">
            ...
            <input type="date" class="form-control form-control-rounded" id="input-26" placeholder="Enter Phone" name="dob" value="{{$data->date_of_birth}}">
