	...
	<div class="card">
        ...
        <div class="card-header">Edit Users</div>
          ...
          @endif
            ...
            <form action="{{ url ('add_app_user')}}" method="post">
          ...
          <div class="form-group row">
            ...
            <input type="email" class="form-control form-control-rounded" id="input-26" placeholder="Enter Email" name="email" value="">
          ...
          <div class="form-group row">
            ...
            <input type="number" class="form-control form-control-rounded" id="input-26" placeholder="Enter Phone" name="phone" value="">
          ...
          <div class="form-group row">
            ...
            <input type="date" class="form-control form-control-rounded" id="input-26" placeholder="Enter Phone" name="dob" value="">
          ...
          <div class="form-group row">
                  ...
                  <select class="form-control form-control-rounded" id="boards_id" name="board_id">
