        ...
        <div class="row pt-2 pb-2">
            ...
            <div class="col-sm-3">
                ...
                <div class="btn-group float-sm-right">
                    ...
                    <a type="button" class="btn btn-primary waves-effect waves-light" href="{{ route('test.create')}}">Add</a>
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header"><i class="fa fa-question-circle"></i>  Mock Test List </div>
                                ...
                                @foreach($data as $row)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if(isset($row->image) && is_file(public_path('images/exam/' .$row->image)))
                                        ...
                                        <td>
                                             ...
                                             <a href="{{ route('test.show', $row->id) }}" class="btn btn-outline-primary btn-sm flex">Add Question</a>

                                            <a href="{{ route('test.edit', $row->id) }}" class="btn btn-primary btn-sm flex"><i class="fa fa-edit" aria-hidden="true"></i> Edit</a>
