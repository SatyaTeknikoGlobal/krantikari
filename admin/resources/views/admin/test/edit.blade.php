...
<div class="container-fluid">
	...
	<div class="card">
        ...
        <div class="card-header">Edit Mock Test</div>
          ...
          @endif
            ...
            <form action="{{ url('test_update')}}" method="post" enctype="multipart/form-data">
           ...
           <div class="row">
            ...
            <div class="row">
              ...
              <div class="col">
                  ...
                  <input type="number" name="time" class="form-control" required="" placeholder="Enter Time in mins" value="{{$exam->session_time}}">
