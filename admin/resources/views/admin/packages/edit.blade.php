	...
	<div class="card">
        ...
        <div class="card-header">Edit Packages Type</div>
          ...
          <div class="col-sm-10">
            ...
            <input type="date" name="start_date" value="{{$edit->start_date}}" placeholder="Enter start_date" id="start_date" class="form-control form-control-rounded" />
          ...
          <div class="col-sm-10">
            ...
            <input type="date" name="end_date" value="{{$edit->end_date}}" placeholder="Enter end_date" id="end_date" class="form-control form-control-rounded" />
