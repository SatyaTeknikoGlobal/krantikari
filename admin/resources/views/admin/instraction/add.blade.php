...
<div class="container-fluid">
    ...
    <!-- End Breadcrumb-->
	<div class="card">
        <div class="card-header">Add Instraction</div>
           <div class="card-body">
           	 @if ($errors->any())
              ...
              @endforeach
          @endif
            <form action="{{ route ('instraction.store')}}" method="post" enctype="multipart/form-data">
            @csrf
          ...
          <div class="form-group row">
                <div class="col-md-6">
                    <div class="lng_fst_com">
                        ...
                        <textarea id='e_content'  name='e_content' style='border: 1px solid black;'></textarea><br>
                    </div>
                </div>
                <!--/.col-->
                <div class="col-md-6">
                    <div class="lng_fst_com">
                        ...
                        <textarea id='h_content' name='h_content' style='border: 1px solid black;'  ></textarea><br>
                    </div>
                </div>
                <!--/.col-->
            </div>
