	...
	<div class="card">
        ...
        <div class="card-header">Edit Banners</div>
          ...
          @endif
            ...
            <form action="{{ route('app_banner.update', $data->id)}}" method="post" enctype="multipart/form-data">
           ...
           <div class="form-group row">
            ...
            <input type="text" class="form-control form-control-rounded" id="input-26" placeholder="Enter Name" name="name"  value="{{$data->timer_text}}">
          ...
          <br>
              ...
              <img src="{{url('public/images/app_banner/'.$data->banner)}}" alt="banner-image" class="banetr" height="80px" width="80px">
           ...
           <div class="form-group row">
            ...
            <div class="col-sm-10">
              ...
              <select class="form-control" name="link">
                ...
                <option value="{{$key->id}}" <?php if($key->id == $data->link) echo "selected";?>>{{$key->title}}</option>
