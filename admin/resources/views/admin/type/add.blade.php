...
<div class="container-fluid">
	...
	<div class="card">
        ...
        <div class="card-header">Add Subcription Type</div>
          ...
          @endif
            ...
            <form action="{{ route('subcription_type.store')}}" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group row">
              ...
              <select class="form-control form-control-rounded" name="type" id="type">
                  ...
                  <option value="course" selected="">Course Wise Subcription</option>
          ...
          <textarea rows="4" name="description"  id="description" style='border: 1px solid black;'></textarea>
   ...
   @if ($message = Session::get('success'))
        ...
        setInterval(function(){ window.location.href="{{ route('subcription_type.index')}}"}, 1500);
