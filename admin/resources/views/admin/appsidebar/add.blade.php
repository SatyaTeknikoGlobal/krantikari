...
<div class="container-fluid">
  ...
  <div class="form-group row">
    ...
    <div class="form-group row" id="filetypelocalimage">
      <label for="input-26" class="col-sm-2 col-form-label">PDF / Image*</label>
      <div class="col-sm-10">
    ...
    <div class="form-group row" id="filetypevideo">
      ...
      <div class="col-sm-10">
        <input type="text" class="form-control" id="input-26" placeholder="Enter Youtube ID" name="file" placeholder="Enter Video ID">
      </div>
    </div>
           ...
           <div class="form-group row">
            ...
            <input type="text" class="form-control form-control-rounded" id="input-26" placeholder="Enter Link" name="link">
